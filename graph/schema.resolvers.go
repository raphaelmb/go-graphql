...
import (
	...
	"github.com/raphaelmb/go-graphql/graph/generated"
	"github.com/raphaelmb/go-graphql/graph/model"
)
...
func (r *mutationResolver) CreateChater(ctx context.Context, input model.NewChapter) (*model.Chapter, error) {
